...
class SelfAttentivePooling(nn.Module):
    def __init__(self, in_dim, bottleneck_dim=128):
        ...
        self.linear1 = nn.Conv1d(in_dim, bottleneck_dim, kernel_size=1)  #  W, b in the paper
        self.linear2 = nn.Conv1d(bottleneck_dim, in_dim, kernel_size=1)  #  V, k in the paper
